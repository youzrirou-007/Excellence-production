...
import excellenceCartesImg from '../assets/images/excellence_cartes.webp';
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 p-6 md:p-10 space-y-8 flex flex-col justify-between font-sans">
      <div className="max-w-7xl mx-auto w-full space-y-8">
        ...
        {/* Header Banner - Fond blanc pur, texture marbre en liseré de bordure discret */}
        <div 
          id="formations-header-banner" 
          className="p-8 md:p-10 rounded-3xl shadow-xl border-2 border-amber-400/50 relative overflow-hidden flex flex-col items-center justify-center text-center space-y-6 bg-white"
        >
          {/* Liseré marbre haut */}
          <div 
            className="absolute top-0 left-0 right-0 h-16 bg-cover bg-top bg-no-repeat pointer-events-none opacity-40"
            style={{ backgroundImage: `url(${excellenceCartesImg})`, maskImage: 'linear-gradient(to bottom, black, transparent)', WebkitMaskImage: 'linear-gradient(to bottom, black, transparent)' }}
          />
          {/* Liseré marbre bas */}
          <div 
            className="absolute bottom-0 left-0 right-0 h-16 bg-cover bg-bottom bg-no-repeat pointer-events-none opacity-40"
            style={{ backgroundImage: `url(${excellenceCartesImg})`, maskImage: 'linear-gradient(to top, black, transparent)', WebkitMaskImage: 'linear-gradient(to top, black, transparent)' }}
          />

          <div className="relative z-10 max-w-4xl space-y-4">
            <div className="inline-flex items-center gap-2 bg-amber-50 text-amber-800 text-[11px] font-black uppercase tracking-widest px-4 py-2 rounded-xl border border-amber-300 shadow-sm">
            ...
            <p className="text-slate-600 text-sm md:text-base font-bold max-w-2xl mx-auto leading-relaxed">
          ...
          {filteredModules.map((mod) => (
            ...
            >
              ...
              <div className="p-7 space-y-5 flex-1 flex flex-col justify-between">
                ...
                <div className="bg-gradient-to-br from-slate-50 via-white to-amber-50/40 rounded-2xl p-4 flex items-center justify-center relative border border-slate-200 h-36 overflow-hidden shadow-inner">
                  {mod.schemaType ? (
                    ...
                    <div className="flex flex-col items-center justify-center text-amber-400 space-y-1">
                      ...
                      <span className="text-[10px] font-black uppercase tracking-widest text-slate-500">ANFO • TOVEX • BOURRAGE 76CM</span>
                    </div>
                  ) : mod.category === 'securite' ? (
                    <div className="flex flex-col items-center justify-center text-rose-500 space-y-1">
                      <ShieldAlert className="w-10 h-10" />
                      <span className="text-[10px] font-black uppercase tracking-widest text-slate-500">AÉRAGE • PURGE • CULOTS 20CM</span>
                    </div>
                  ) : (
                    <div className="flex flex-col items-center justify-center text-indigo-400 space-y-1">
                      <BarChart3 className="w-10 h-10" />
                      <span className="text-[10px] font-black uppercase tracking-widest text-slate-500">MUCKPILE • D50 • OVERBREAK</span>
                    </div>
                  )}
                </div>
