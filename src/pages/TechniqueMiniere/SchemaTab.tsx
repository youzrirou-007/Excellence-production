...
<body>
  ...
  // Mineur Parfait high-fidelity color getters
  ...
  const getHoleColorHex = (hole: HoleInfo) => getCouleur(hole.type);
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 bg-white rounded-3xl p-6 border border-slate-100 shadow-xs">
      ...
      <div className="lg:col-span-9 space-y-6 flex flex-col justify-between">
        ...
        {/* INTERACTIVE GROUP FILTER TOOLBAR (Mineur Parfait Fidelity) */}
        <div className="bg-slate-900/90 border border-slate-800 p-3 rounded-2xl flex flex-wrap items-center justify-between gap-2 shadow-xl">
          <div className="flex items-center gap-1.5 flex-wrap">
            <span className="text-[10px] font-black uppercase text-amber-400 bg-amber-400/10 px-2.5 py-1 rounded-lg border border-amber-400/20 mr-1">
              Filtre Séquence
            </span>
            <button
            ...
            >
              Tous ({holesToRender.length})
            </button>
            <button
              onClick={() => setActiveGroup(activeGroup === 'vide' ? null : 'vide')}
              onMouseEnter={() => { if (activeGroup === null) setActiveGroup('vide'); }}
              onMouseLeave={() => { if (activeGroup === 'vide' && !hoveredHole) setActiveGroup(null); }}
              className={`px-2.5 py-1.5 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer ${
                activeGroup === 'vide'
                  ? 'bg-blue-400 text-slate-950 font-black shadow-md shadow-blue-400/20 scale-105'
                  : 'bg-slate-800/80 text-slate-300 hover:bg-slate-800 border border-slate-700/50'
              }`}
            >
              <span className="w-2.5 h-2.5 rounded-full bg-blue-400 border border-white inline-block" />
              Vides (Ø102)
            </button>
            <button
              onClick={() => setActiveGroup(activeGroup === 'charge' ? null : 'charge')}
              onMouseEnter={() => { if (activeGroup === null) setActiveGroup('charge'); }}
              onMouseLeave={() => { if (activeGroup === 'charge' && !hoveredHole) setActiveGroup(null); }}
              className={`px-2.5 py-1.5 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer ${
                activeGroup === 'charge'
            ...
            <button
              onClick={() => setActiveGroup(activeGroup === 'g1' ? null : 'g1')}
              onMouseEnter={() => { if (activeGroup === null) setActiveGroup('g1'); }}
              onMouseLeave={() => { if (activeGroup === 'g1' && !hoveredHole) setActiveGroup(null); }}
              className={`px-2.5 py-1.5 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer ${
                activeGroup === 'g1'
                  ? 'bg-emerald-500 text-white font-black shadow-md shadow-emerald-500/20 scale-105'
                  : 'bg-slate-800/80 text-slate-300 hover:bg-slate-800 border border-slate-700/50'
              }`}
            >
            ...
            <button
              onClick={() => setActiveGroup(activeGroup === 'g2' ? null : 'g2')}
              onMouseEnter={() => { if (activeGroup === null) setActiveGroup('g2'); }}
              onMouseLeave={() => { if (activeGroup === 'g2' && !hoveredHole) setActiveGroup(null); }}
              className={`px-2.5 py-1.5 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer ${
                activeGroup === 'g2'
                  ? 'bg-orange-500 text-white font-black shadow-md shadow-orange-500/20 scale-105'
                  : 'bg-slate-800/80 text-slate-300 hover:bg-slate-800 border border-slate-700/50'
              }`}
            >
            ...
            <button
              onClick={() => setActiveGroup(activeGroup === 'g3' ? null : 'g3')}
              onMouseEnter={() => { if (activeGroup === null) setActiveGroup('g3'); }}
              onMouseLeave={() => { if (activeGroup === 'g3' && !hoveredHole) setActiveGroup(null); }}
              className={`px-2.5 py-1.5 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer ${
                activeGroup === 'g3'
            ...
            {!is9m2 && (
              <button
                onClick={() => setActiveGroup(activeGroup === 'g4' ? null : 'g4')}
                onMouseEnter={() => { if (activeGroup === null) setActiveGroup('g4'); }}
                onMouseLeave={() => { if (activeGroup === 'g4' && !hoveredHole) setActiveGroup(null); }}
                className={`px-2.5 py-1.5 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer ${
                  activeGroup === 'g4'
                    ? 'bg-purple-500 text-white font-black shadow-md shadow-purple-500/20 scale-105'
                    : 'bg-slate-800/80 text-slate-300 hover:bg-slate-800 border border-slate-700/50'
                }`}
              >
            ...
            <button
              onClick={() => setActiveGroup(activeGroup === 'radier' ? null : 'radier')}
              onMouseEnter={() => { if (activeGroup === null) setActiveGroup('radier'); }}
              onMouseLeave={() => { if (activeGroup === 'radier' && !hoveredHole) setActiveGroup(null); }}
              className={`px-2.5 py-1.5 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer ${
                activeGroup === 'radier'
                  ? 'bg-violet-500 text-white font-black shadow-md shadow-violet-500/20 scale-105'
                  : 'bg-slate-800/80 text-slate-300 hover:bg-slate-800 border border-slate-700/50'
              }`}
            >
              <span className="w-2.5 h-2.5 rounded-full bg-violet-500 inline-block" />
              Radier ({is9m2 ? '100ms' : '125ms'})
            </button>
            <button
              onClick={() => setActiveGroup(activeGroup === 'parement' ? null : 'parement')}
              onMouseEnter={() => { if (activeGroup === null) setActiveGroup('parement'); }}
              onMouseLeave={() => { if (activeGroup === 'parement' && !hoveredHole) setActiveGroup(null); }}
              className={`px-2.5 py-1.5 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer ${
                activeGroup === 'parement'
                  ? 'bg-teal-400 text-slate-950 font-black shadow-md shadow-teal-400/20 scale-105'
                  : 'bg-slate-800/80 text-slate-300 hover:bg-slate-800 border border-slate-700/50'
              }`}
            >
              <span className="w-2.5 h-2.5 rounded-full bg-teal-400 inline-block" />
              Parements ({is9m2 ? '100ms' : '125ms'})
            </button>
            <button
              onClick={() => setActiveGroup(activeGroup === 'voute' ? null : 'voute')}
              onMouseEnter={() => { if (activeGroup === null) setActiveGroup('voute'); }}
              onMouseLeave={() => { if (activeGroup === 'voute' && !hoveredHole) setActiveGroup(null); }}
              className={`px-2.5 py-1.5 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer ${
                activeGroup === 'voute'
            ...
            >
              ...
              Voûte ({is9m2 ? '125ms' : '150ms'})
            </button>
          </div>
          {activeGroup !== null && (
            <button
              onClick={() => setActiveGroup(null)}
              className="text-[11px] text-amber-400 hover:text-amber-300 underline font-bold px-2 py-1 cursor-pointer"
            >
          ...
          {!view3D && (
            ...
            <defs>
              ...
              <clipPath id="gallery-clip-9m2">
                <path d="M 200 600 L 200 420 Q 200 180 500 100 Q 800 180 800 420 L 800 600 Z" />
              </clipPath>
              <clipPath id="gallery-clip-12m2">
                <path d="M 100 670 L 100 430 Q 100 200 500 80 Q 900 200 900 430 L 900 670 Z" />
              </clipPath>
            ...
            >
              ...
              {/* Gallery Tunnel Face Silhouette & Contour (Mineur Parfait Geometry) */}
              {is9m2 ? (
                <g>
                  <path
                    d="M 200 600 L 200 420 Q 200 180 500 100 Q 800 180 800 420 L 800 600 Z"
                  ...
                  />
                  <path
                    d="M 206 594 L 206 422 Q 206 186 500 108 Q 794 186 794 422 L 794 594 Z"
                    fill="none"
                    stroke="#ffd700"
                    strokeWidth="1"
                    opacity="0.3"
                ...
                <g>
                  <path
                    d="M 100 670 L 100 430 Q 100 200 500 80 Q 900 200 900 430 L 900 670 Z"
                    fill="url(#granite-rock)"
                    stroke="#b8860b"
                    strokeWidth="4"
                    className="drop-shadow-[0_20px_40px_rgba(0,0,0,0.9)]"
                  />
                  <path
                    d="M 108 662 L 108 432 Q 108 206 500 88 Q 892 206 892 432 L 892 662 Z"
                    fill="none"
                    stroke="#ffd700"
                    strokeWidth="1"
                    opacity="0.3"
              ...
              {/* Reference Grid Laser Crosshairs at Tunnel Center (Mineur Parfait) */}
              ...
              {activeStep === maxStep && (
                <motion.path
                  d={is9m2 ? "M 200 600 L 200 420 Q 200 180 500 100 Q 800 180 800 420 L 800 600 Z" : "M 100 670 L 100 430 Q 100 200 500 80 Q 900 200 900 430 L 900 670 Z"}
                  fill="#000000"
                  stroke="#22c55e"
                  strokeWidth="4"
                  initial={{ opacity: 0.8 }}
              ...
              {/* DRAW ALL HOLES (Mineur Parfait Interactive Group Fidelity) */}
              {holesToRender.map((hole) => {
                const status = getHoleStatus(hole);
                const isHoleActive = activeGroup === null || activeGroup === hole.type || activeGroup === hole.delay || (activeGroup === 'contour' && (hole.type === 'radier' || hole.type === 'parement' || hole.type === 'voute'));
                const isHovered = hoveredHole?.id === hole.id;
                const arrowCoords = getArrowCoords(hole);

                return (
                  <g
                    key={hole.id}
                    opacity={isHoleActive ? 1 : 0.22}
                  ...
                  >
                    ...
                    {/* Force Vector Thrust Arrow pointing to Void when hovered */}
                    {status !== 'exploded' && isHovered && arrowCoords && hole.type !== 'vide' && (
                    ...
                    {/* Physical Hole Circles & Badges */}
                    {status !== 'exploded' && (
                      <>
                        {/* EMPTY HOLE (Ø 102 mm expansion void - Double concentric rings) */}
                        {hole.type === 'vide' ? (
                          <g
                            className="cursor-pointer"
                            onMouseEnter={() => {
                              setHoveredHole(hole);
                              if (activeGroup === null) setActiveGroup('vide');
                            }}
                            onMouseLeave={() => {
                              setHoveredHole(null);
                              if (activeGroup === 'vide') setActiveGroup(null);
                            }}
                          >
                            {/* Outer Expansion Void Ring */}
                            <circle
                              cx={hole.x}
                              cy={hole.y}
                              r={isHovered ? (is9m2 ? 15 : 22) : (is9m2 ? 12 : 17)}
                              fill="#60a5fa"
                              stroke="#3b82f6"
                              strokeWidth="2.5"
                          ...
                          /* CHARGED HOLE (Detonator Delay Group) */
                          <g
                            className="cursor-pointer"
                            onMouseEnter={() => {
                              setHoveredHole(hole);
                              if (activeGroup === null) setActiveGroup(hole.type);
                            }}
                            onMouseLeave={() => {
                              setHoveredHole(null);
                              if (activeGroup === hole.type) setActiveGroup(null);
                            }}
                          >
                            {/* Glowing Active Ring when hovered or active in group */}
                            {(isHovered || (activeGroup !== null && isHoleActive)) && (
                              <motion.circle
                                cx={hole.x}
                                cy={hole.y}
                                r={is9m2 ? 16 : 24}
                            ...
                            <circle
                              cx={hole.x}
                              cy={hole.y}
                              r={isHovered ? (is9m2 ? 13 : 19) : (is9m2 ? 10.5 : 15.5)}
                            ...
                            {/* Hole Delay Number Label */}
                            <text
                              x={hole.x}
                              y={hole.y + (is9m2 ? 3.5 : 4.5)}
                              textAnchor="middle"
                              fill={hole.type === 'charge' ? '#111827' : '#ffffff'}
                              fontSize={is9m2 ? "8.5" : "11.5"}
                              fontWeight="900"
                              className="select-none pointer-events-none font-mono"
                            >
                              {hole.label}
